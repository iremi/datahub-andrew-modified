...
import com.linkedin.datahub.graphql.generated.Dashboard2Properties;
...
public class Dashboard2SnapshotMapper implements ModelMapper<Dashboard2Snapshot, Dashboard2> {
    ...
    public Dashboard2 apply(@Nonnull final Dashboard2Snapshot dashboard2) {
        ...
        result.setDashboard2Id("TestId");
        result.setTool("TestTool");
        ...
        ModelUtils.getAspectsFromSnapshot(dashboard2).forEach(aspect -> {
            if (aspect instanceof com.linkedin.dashboard2.Dashboard2Info) {
                ...
                result.setProperties(mapDashboard2InfoToProperties(info));
     ...
     */
    private Dashboard2Properties mapDashboard2InfoToProperties(final com.linkedin.dashboard2.Dashboard2Info info) {
        final Dashboard2Properties result = new Dashboard2Properties();
        result.setDescription(info.getDescription());
        result.setName(info.getTitle());
        result.setLastRefreshed(info.getLastRefreshed());
