...
public class CorpUserProperties implements java.io.Serializable {
    ...
    public CorpUserProperties(boolean active, String displayName, String email, String title, CorpUser manager, Long departmentId, String departmentName, String firstName, String lastName, String fullName, String countryCode) {
        this.active = active;
    ...
    public static class Builder {
        ...
        public CorpUserProperties build() {
            return new CorpUserProperties(active, displayName, email, title, manager, departmentId, departmentName, firstName, lastName, fullName, countryCode);
        }
