...
public class CorpUserEditableProperties implements java.io.Serializable {
    ...
    public CorpUserEditableProperties(String aboutMe, java.util.List<String> teams, java.util.List<String> skills, String pictureLink) {
    ...
    public static class Builder {
        ...
        public CorpUserEditableProperties build() {
            return new CorpUserEditableProperties(aboutMe, teams, skills, pictureLink);
        }
