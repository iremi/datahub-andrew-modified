...
public class GlossaryTermInfo implements java.io.Serializable {
    ...
    public GlossaryTermInfo(String definition, String termSource, String sourceRef, String sourceUrl, java.util.List<StringMapEntry> customProperties, String rawSchema) {
    ...
    public static class Builder {
        ...
        public GlossaryTermInfo build() {
            return new GlossaryTermInfo(definition, termSource, sourceRef, sourceUrl, customProperties, rawSchema);
        }
