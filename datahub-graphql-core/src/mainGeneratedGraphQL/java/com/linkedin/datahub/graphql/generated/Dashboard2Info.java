...
/**
 * Deprecated, use Dashboard2Properties instead
Additional read only info about a Dashboard2
 */
@javax.annotation.Generated(
    value = "com.kobylynskyi.graphql.codegen.GraphQLCodegen",
    date = "2021-11-16T14:06:41+0100"
)
public class Dashboard2Info implements java.io.Serializable {
    ...
    public Dashboard2Info(String name, String description, java.util.List<Chart> charts, String externalUrl, AccessLevel access, java.util.List<StringMapEntry> customProperties, Long lastRefreshed, AuditStamp created, AuditStamp lastModified, AuditStamp deleted) {
        this.name = name;
...
Charts that comprise the dashboard2
     */
    @Deprecated
...
Note that this will soon be deprecated for low usage
    ...
    public static Dashboard2Info.Builder builder() {
        return new Dashboard2Info.Builder();
    }
...
Note that this will soon be deprecated for low usage
        ...
        public Dashboard2Info build() {
            return new Dashboard2Info(name, description, charts, externalUrl, access, customProperties, lastRefreshed, created, lastModified, deleted);
        }
