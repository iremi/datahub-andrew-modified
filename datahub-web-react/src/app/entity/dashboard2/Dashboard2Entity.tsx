...
import {
    GetDashboard2Query,
    useGetDashboard2Query,
    useUpdateDashboard2Mutation,
} from '../../../graphql/dashboard2.generated';
import { Dashboard2, EntityType, PlatformType, SearchResult } from '../../../types.generated';
...
import { Dashboard2ChartsTab } from '../shared/tabs/Entity/Dashboard2ChartsTab';
import { PropertiesTab } from '../shared/tabs/Properties/PropertiesTab';
import { GenericEntityProperties } from '../shared/types';
import { Dashboard2Preview } from './preview/Dashboard2Preview';
...
export class Dashboard2Entity implements Entity<Dashboard2> {
    ...
    renderProfile = (urn: string) => (
        <EntityProfile
            ...
            useUpdateQuery={useUpdateDashboard2Mutation}
    ...
    getOverridePropertiesFromEntity = (dashboard2?: Dashboard2 | null): GenericEntityProperties => {
        ...
        const tool = dashboard2?.tool || '';
        const name = dashboard2?.properties?.name;
        const externalUrl = dashboard2?.properties?.externalUrl;
        return {
            name,
            externalUrl,
            platform: {
