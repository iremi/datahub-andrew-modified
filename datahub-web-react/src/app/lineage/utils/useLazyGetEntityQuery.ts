...
import { useGetDashboard2LazyQuery } from '../../../graphql/dashboard2.generated';
...
export default function useLazyGetEntityQuery() {
    ...
    const [getAsyncDashboard2, { data: asyncDashboard2Data }] = useGetDashboard2LazyQuery();
    ...
    const getAsyncEntity = useCallback(
        (urn: string, type: EntityType) => {
            ...
            if (type === EntityType.Dashboard2) {
                setFetchedEntityType(type);
                getAsyncDashboard2({ variables: { urn } });
            }
    ...
    const returnEntityAndType: EntityAndType | undefined = useMemo(() => {
        ...
        switch (fetchedEntityType) {
            ...
            case EntityType.Dashboard:
                ...
                break;
            case EntityType.Dashboard2:
                returnData = asyncDashboard2Data?.dashboard2;
                if (returnData) {
                    return {
                        entity: returnData,
