...
import { useGetDashboard2Query } from '../../../graphql/dashboard2.generated';
...
export default function useGetEntityQuery(urn: string, entityType?: EntityType) {
    const allResults = {
        ...
        [EntityType.Dashboard2]: useGetDashboard2Query({
            variables: { urn },
            skip: entityType !== EntityType.Dashboard2,
        }),
    ...
    const returnEntityAndType: EntityAndType | undefined = useMemo(() => {
        ...
        // eslint-disable-next-line react-hooks/exhaustive-deps
        allResults[EntityType.Dashboard2],
        // eslint-disable-next-line react-hooks/exhaustive-deps
