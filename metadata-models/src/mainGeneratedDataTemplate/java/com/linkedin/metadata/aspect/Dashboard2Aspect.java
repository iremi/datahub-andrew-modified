    ...
    implements HasTyperefInfo
{
    ...
    private final static TyperefInfo TYPEREFINFO = new Dashboard2Aspect.UnionTyperefInfo();

    public Dashboard2Aspect() {
        super(new DataMap(2, 0.75F), SCHEMA);
    }

    public Dashboard2Aspect(Object data) {
        super(data, SCHEMA);
    }

    public static Dashboard2Aspect create(com.linkedin.metadata.key.Dashboard2Key value) {
        Dashboard2Aspect newUnion = new Dashboard2Aspect();
        newUnion.setDashboard2Key(value);
        return newUnion;
    }

    public boolean isDashboard2Key() {
        return memberIs("com.linkedin.metadata.key.Dashboard2Key");
    }

    public com.linkedin.metadata.key.Dashboard2Key getDashboard2Key() {
        return obtainWrapped(MEMBER_Dashboard2Key, com.linkedin.metadata.key.Dashboard2Key.class, "com.linkedin.metadata.key.Dashboard2Key");
    }

    public void setDashboard2Key(com.linkedin.metadata.key.Dashboard2Key value) {
        selectWrapped(MEMBER_Dashboard2Key, com.linkedin.metadata.key.Dashboard2Key.class, "com.linkedin.metadata.key.Dashboard2Key", value);
    }

    public static Dashboard2Aspect create(com.linkedin.dashboard2.Dashboard2Info value) {
        Dashboard2Aspect newUnion = new Dashboard2Aspect();
        newUnion.setDashboard2Info(value);
        return newUnion;
    }

    public boolean isDashboard2Info() {
        return memberIs("com.linkedin.dashboard2.Dashboard2Info");
    }

    public com.linkedin.dashboard2.Dashboard2Info getDashboard2Info() {
        return obtainWrapped(MEMBER_Dashboard2Info, com.linkedin.dashboard2.Dashboard2Info.class, "com.linkedin.dashboard2.Dashboard2Info");
    }

    public void setDashboard2Info(com.linkedin.dashboard2.Dashboard2Info value) {
        selectWrapped(MEMBER_Dashboard2Info, com.linkedin.dashboard2.Dashboard2Info.class, "com.linkedin.dashboard2.Dashboard2Info", value);
    }

    public static Dashboard2Aspect create(com.linkedin.dashboard2.EditableDashboard2Properties value) {
        Dashboard2Aspect newUnion = new Dashboard2Aspect();
        newUnion.setEditableDashboard2Properties(value);
        return newUnion;
    }

    public boolean isEditableDashboard2Properties() {
        return memberIs("com.linkedin.dashboard2.EditableDashboard2Properties");
    }

    public com.linkedin.dashboard2.EditableDashboard2Properties getEditableDashboard2Properties() {
        return obtainWrapped(MEMBER_EditableDashboard2Properties, com.linkedin.dashboard2.EditableDashboard2Properties.class, "com.linkedin.dashboard2.EditableDashboard2Properties");
    }

    public void setEditableDashboard2Properties(com.linkedin.dashboard2.EditableDashboard2Properties value) {
        selectWrapped(MEMBER_EditableDashboard2Properties, com.linkedin.dashboard2.EditableDashboard2Properties.class, "com.linkedin.dashboard2.EditableDashboard2Properties", value);
    }

    public static Dashboard2Aspect create(com.linkedin.common.Ownership value) {
        Dashboard2Aspect newUnion = new Dashboard2Aspect();
    ...
    public static Dashboard2Aspect create(com.linkedin.common.Status value) {
        Dashboard2Aspect newUnion = new Dashboard2Aspect();
    ...
    public static Dashboard2Aspect create(com.linkedin.common.GlobalTags value) {
        Dashboard2Aspect newUnion = new Dashboard2Aspect();
    ...
    public static Dashboard2Aspect create(com.linkedin.common.BrowsePaths value) {
        Dashboard2Aspect newUnion = new Dashboard2Aspect();
    ...
    public static Dashboard2Aspect create(com.linkedin.common.GlossaryTerms value) {
        Dashboard2Aspect newUnion = new Dashboard2Aspect();
    ...
    public static Dashboard2Aspect create(com.linkedin.common.InstitutionalMemory value) {
        Dashboard2Aspect newUnion = new Dashboard2Aspect();
    ...
    public static Dashboard2Aspect create(com.linkedin.common.DataPlatformInstance value) {
        Dashboard2Aspect newUnion = new Dashboard2Aspect();
    ...
    @Override
    public Dashboard2Aspect clone()
        throws CloneNotSupportedException
    {
        return ((Dashboard2Aspect) super.clone());
    }

    @Override
    public Dashboard2Aspect copy()
        throws CloneNotSupportedException
    {
        return ((Dashboard2Aspect) super.copy());
    }
        ...
        extends PathSpec
    {
        ...
        public com.linkedin.metadata.key.Dashboard2Key.Fields Dashboard2Key() {
            return new com.linkedin.metadata.key.Dashboard2Key.Fields(getPathComponents(), "com.linkedin.metadata.key.Dashboard2Key");
        }

        public com.linkedin.dashboard2.Dashboard2Info.Fields Dashboard2Info() {
            return new com.linkedin.dashboard2.Dashboard2Info.Fields(getPathComponents(), "com.linkedin.dashboard2.Dashboard2Info");
        }

        public com.linkedin.dashboard2.EditableDashboard2Properties.Fields EditableDashboard2Properties() {
            return new com.linkedin.dashboard2.EditableDashboard2Properties.Fields(getPathComponents(), "com.linkedin.dashboard2.EditableDashboard2Properties");
        }
    ...
    /**
     * A union of all supported metadata aspects for a Dashboard2
     * 
     */
